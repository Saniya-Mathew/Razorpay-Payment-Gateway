...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_processing_values(self, processing_values):
        ...
        if self.provider_code != 'razorpay_v25':
            return res
    ...
    def _send_payment_request(self):
        ...
        if not self.token_id:
            raise UserError("Razorpay V25: " + _("The transaction is not linked to a token."))
    ...
    def _send_refund_request(self, amount_to_refund=None):
        ...
        refund_tx._handle_notification_data('razorpay_v25', response_content)
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        if provider_code != 'razorpay_v25' or len(tx) == 1:
            return tx
        ...
        if entity_type == 'payment':
            ...
            if not reference:
                raise ValidationError("Razorpay V25: " + _("Received data with missing reference."))
