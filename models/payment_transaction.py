...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_processing_values(self, processing_values):
        ...
        if self.provider_code != 'razorpay_v25' or self.operation in ('online_token', 'offline'):
            return res or {}
        ...
        return {
            'razorpay_v25_key_id': self.provider_id.razorpay_v25_key_id,
